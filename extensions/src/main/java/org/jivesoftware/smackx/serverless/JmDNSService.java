...
public class JmDNSService extends LLService implements ServiceNameListener {
    ...
    protected void registerService() throws XMPPException {
        ...
        try {
            ...
            throw new XMPPException.XMPPErrorException("Unable to register mDNS service with name " + serviceInfo.getQualifiedName(),
    ...
    protected void reannounceService() throws XMPPException {
        try {
            ...
            throw new XMPPException.XMPPErrorException("Exception occured when reannouncing mDNS presence.",
                    new XMPPError(XMPPError.Condition.conflict), ioe);
        }
    }
