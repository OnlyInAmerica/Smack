...
//    }
    ...
    private LLServiceDiscoveryManager(LLService llservice, XMPPConnection connection) {
        super(connection);
        ...
        // I don't understand what's going on below:
        // -dbro
...
//    TODO: Verify superclass behavior is desired
//    The ServiceDiscoveryManager methods used here are not static, but
//    ServiceDiscoveryManager#getInstanceFor(XMPPConnection) is
//    /**
...
//    }
     ...
     */
    private XMPPLLConnection getConnection(String serviceName) throws XMPPException, SmackException {
     ...
     */
    private ServiceDiscoveryManager getInstance(String serviceName) throws XMPPException, SmackException {
     ...
     */
    @Override
    public DiscoverInfo discoverInfo(String serviceName) throws XMPPException, SmackException {
        ...
        if (info == null) {
            ...
            if (capsManager != null) {
                ...
                node = EntityCapsManager.getNodeVersionByJid(serviceName);
            }
     ...
     * @throws XMPPException if the operation failed for some reason.
     */
    public DiscoverInfo discoverInfo(String serviceName, String node) throws XMPPException, SmackException {
        ...
        if (result == null) {
            throw new XMPPException.XMPPErrorException("No response from the server.",
        ...
        throw new XMPPException.XMPPErrorException("Result was not a disco info reply.",
     ...
     * @throws XMPPException if the operation failed for some reason.
     */
    public DiscoverItems discoverItems(String entityID) throws XMPPException, SmackException {
     ...
     * directly addressable.
     * 
     * @param serviceName the address of the XMPP entity.
     * @param node the attribute that supplements the 'jid' attribute.
     * @return the discovered items.
     * @throws XMPPException if the operation failed for some reason.
     */
    public DiscoverItems discoverItems(String serviceName, String node) throws XMPPException, SmackException {
        ...
        throw new XMPPException.XMPPErrorException("Result was not a disco items reply.",
                new XMPPError(XMPPError.Condition.undefined_condition));
    }
     ...
     */
    @Override
    public boolean canPublishItems(String entityID) throws XMPPException, SmackException {
